...
claude --plugin-dir ~/repos/context-engineering-workflows/plugins/<plugin-name>
```
...
For a persistent local install instead, `claude plugin marketplace add ~/repos/context-engineering-workflows`
